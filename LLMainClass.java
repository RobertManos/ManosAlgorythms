		...
		try{
			...
			if(dtype.equals("VEC")){
				...
				if(V == null){	
					...
					System.out.println("NULL: Illegal Input File1 "+fname);
					return;
				}
				...
				for(int i = 2; i < n; i+=2){
					...
					{	System.out.println("NULL: Illegal Input File2 "+fname);
						return;
					}
	    	...
	    	System.out.println("NULL: Something is wrong "+e.toString()+e.getMessage()+e.getLocalizedMessage()+e.getStackTrace().toString());
	        return;
	    }
	}
}
